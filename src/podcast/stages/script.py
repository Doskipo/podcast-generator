...
def _build_prompts(profile: Profile, outline: Outline, articles: list[Article]) -> tuple[str, str]:
    ...
    system_prompt = (
        ...
        "checklist of subjects that must appear in every episode. Let it shape *how* a host "
        "engages with a story — their angle, their reaction, an analogy they'd reach for — "
        "never force a pet subject into a story where it doesn't genuinely belong.\n\n"
